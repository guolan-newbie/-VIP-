...
<div class="pd-20">
	...
	<div class="page-nav">
<a><button type="button">上一页</button></a><a><button type="button">1</button></a><a><button id="btn-currentpage" type="button">2</button></a><a><button type="button">3</button></a><a><button type="button">下一页</button></a>
</div>
</div>
